...
trait AsaasTrait
{
     ...
     */
    public static function requestDepositAsaas($data)
    {
        try {
            ...
            $chargeData = [
                ...
                'customer_name' => $data->debtor_name ?? 'Cliente',
                'customer_email' => $data->email ?? 'redacted@example.invalid',
                'customer_phone' => $data->phone ?? '11999999999',
                'customer_document' => $data->debtor_document_number ?? '00000000000',
