...
class DepositController extends Controller
{
    ...
    public function makeDeposit(Request $request)
    {
        ...
        \Log::info('DepositController - User object', ['present' => $request->user ? 'Presente' : 'Ausente']);
        if ($request->user) {
            \Log::info('DepositController - User ID', ['id' => $request->user->id]);
            \Log::info('DepositController - User user_id', ['user_id' => $request->user->user_id]);
        }
