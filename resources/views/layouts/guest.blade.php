...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .swal2-title { color: hsl(var(--foreground)) !important; font-size: 1.125rem !important; font-weight: 600 !important; }
...
<body>
    ...
    <footer style="position: fixed; bottom: 0; left: 0; right: 0; background: hsl(var(--secondary)); border-top: 1px solid hsl(var(--border)); padding: 1rem; transition: background-color 0.2s, border-color 0.2s;">
