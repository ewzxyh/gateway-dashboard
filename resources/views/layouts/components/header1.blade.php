...
<style>
    ...
    .glassmorphism-toggle:hover::before {
        left: 100% !important;
    }
    ...
    .glassmorphism-toggle:hover .toggle-icon {
    ...
    .glassmorphism-toggle:hover .toggle-line-1 {
        transform: translateY(1px) rotate(3deg) !important;
    }

    .glassmorphism-toggle:hover .toggle-line-2 {
        transform: scaleX(0.8) !important;
        opacity: 0.7 !important;
    }

    .glassmorphism-toggle:hover .toggle-line-3 {
        transform: translateY(-1px) rotate(-3deg) !important;
    }

    /* Dark theme support */
    [data-theme="dark"] .glassmorphism-toggle {
        background: var(--glass-bg, rgba(0, 0, 0, 0.2)) !important;
        border-color: var(--glass-border, rgba(255, 255, 255, 0.1)) !important;
    }

    [data-theme="dark"] .glassmorphism-toggle:hover {
    ...
    <div class="main-header-container container-fluid">
        ...
        <div class="header-content-left">
            ...
            <div class="mx-2 header-element mx-lg-0">
                <a aria-label="Hide Sidebar" class="sidemenu-toggle header-link animated-arrow hor-toggle horizontal-navtoggle glassmorphism-toggle" data-bs-toggle="sidebar" href="javascript:void(0);">
        ...
        <ul class="header-content-right">
            ...
            <!-- Start::header-element -->
            <li class="header-element notifications-dropdown d-lg-block d-none dropdown">
                <!-- Start::header-link|dropdown-toggle -->
