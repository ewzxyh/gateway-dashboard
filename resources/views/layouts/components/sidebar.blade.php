...
<style>
    /* Previne o flash dos elementos collapse */
    .drawer .collapse {
        visibility: hidden;
        height: 0 !important;
        overflow: hidden;
    ...
    /* Mostra apenas quando explicitamente expandido */
    ...
    /* Melhora a aparência dos ícones de expansão */
...
<!-- Script inline para execução imediata -->
<script>
    // Executa imediatamente para garantir que colapses estejam ocultos
    (function() {
        // Força todos os colapses a ficarem ocultos inicialmente
        const style = document.createElement('style');
        style.textContent = `
            .drawer .collapse:not(.show) {
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Aguarda um pequeno delay para garantir que o Bootstrap foi inicializado
        setTimeout(function() {
