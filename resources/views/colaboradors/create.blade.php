...
<head>
    <title>Criar Colaboradores</title>
    ...
    <div
        ...
        <div class="w-1/4">
            <div class="flex justify-center my-2 w-full">
                <h1 class="text-xl font-bold my-2">Criar Colaboradores</h1>
            </div>
            <hr>
            <form method="post" action="{{ route('colaboradors.store') }}">
                ...
                <div class="flex flex-col gep-y-2">
                    ...
                    <input class="px-2 h-10 border border-black" type="text" name="email" required><br>
                </div>
                <div class="flex flex-col gep-y-2">
                ...
                <div class="flex flex-col gep-y-2">
                    ...
                    <input class="px-2 h-10 border border-black" type="text" name="unidade_id" required><br>
                </div>
