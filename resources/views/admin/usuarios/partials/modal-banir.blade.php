    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Você tem certeza que deseja {{ $user->banido == 0 ? 'banir' : 'desbanir' }} o usuário <span class="text-highlight">{{ $user->name }}</span>?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-cancel-glass ml-2" data-bs-dismiss="modal">
                ...
                <form method="POST" action="{{ route('admin.usuarios.mudarstatus') }}" style="display: inline;">
                    ...
                    @if($user->banido == 0)
                        <button type="submit" class="btn btn-primary btn-ban-glass">
                            <i class="fas fa-ban me-2"></i>Banir
                        </button>
                    @else
                        <button type="submit" class="btn btn-glassmorphism btn-unban-glass">
                            <i class="fas fa-unlock me-2"></i>Desbanir
                        </button>
                    @endif
                </form>
            </div>
