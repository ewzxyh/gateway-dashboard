...
<div class="modal fade glassmorphism-taxas-modal" id="taxasModal-{{ $user->id }}" data-user-name="{{ $user->name }}" tabindex="-1" aria-labelledby="taxasModalLabel-{{ $user->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="taxasModalLabel-{{ $user->id }}">
                    <i class="fas fa-dollar-sign me-2" style="color: #ffc107;"></i>Configuração de Taxas - {{ $user->name }}
                </h5>
            ...
            <div class="modal-body">
                ...
                <form id="taxasForm-{{ $user->id }}">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="2.00"
                                       value="2.00">
                                <small class="text-white-50">Taxa percentual aplicada sobre o valor do depósito</small>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="0.50"
                                       value="0.50">
                                <small class="text-white-50">Taxa fixa aplicada em todos os depósitos</small>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="1.00"
                                       value="1.00">
                                <small class="text-white-50">Valor mínimo que o usuário pode depositar</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="taxa-card">
                        ...
                        <div class="alert alert-info mb-3" style="background: rgba(23, 162, 184, 0.2); border: 1px solid rgba(23, 162, 184, 0.3); color: #ffffff;">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="2.00"
                                       value="2.00">
                                <small class="text-white-50">Taxa percentual aplicada sobre o valor do saque PIX</small>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="0.80"
                                       value="0.80">
                                <small class="text-white-50">Valor mínimo de taxa para saques PIX</small>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="0.20"
                                       value="0.20">
                                <small class="text-white-50">Taxa fixa adicional aplicada sobre saques PIX</small>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="1.00"
                                       value="1.00">
                                <small class="text-white-50">Valor mínimo que o usuário pode sacar</small>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="50000.00">
                                <small class="text-white-50">Limite máximo de saques por mês para pessoa física</small>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="2.00"
                                       value="2.00">
                                <small class="text-white-50">Taxa percentual para saques realizados via API externa</small>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="2.00"
                                       value="2.00">
                                <small class="text-white-50">Taxa percentual para saques em criptomoedas</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="taxa-card">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <small class="text-white-50">Quando ativado, o sistema aplicará taxas diferentes baseadas no valor do depósito</small>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="15.00"
                                       value="15.00">
                                <small class="text-white-50">Depósitos abaixo deste valor terão taxa fixa</small>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="0.80"
                                       value="0.80">
                                <small class="text-white-50">Taxa fixa para depósitos abaixo do valor mínimo</small>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="2.00"
                                       value="2.00">
                                <small class="text-white-50">Taxa percentual para depósitos acima do valor mínimo</small>
                            </div>
                        </div>
                        
                        <div class="alert alert-warning" style="background: rgba(255, 193, 7, 0.2); border: 1px solid rgba(255, 193, 7, 0.3); color: #ffffff;">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-glassmorphism" style="background: rgba(108, 117, 125, 0.3); border-color: rgba(108, 117, 125, 0.5);" onclick="desativarTaxasPersonalizadas({{ $user->id }})" id="btn-desativar-{{ $user->id }}" style="display: none;">
                    <i class="fas fa-globe me-2"></i>Usar Taxas Globais
                </button>
                <button type="button" class="btn btn-glassmorphism btn-save-glass" onclick="salvarTaxas({{ $user->id }})">
                    <i class="fas fa-save me-2"></i>Salvar Taxas
                </button>
            </div>
        </div>
    </div>
